...
SafeAddString(LBOOKS_THANK_YOU3100,				"Ich habe vielleicht noch nicht alle Bücher gefunden", 1)
SafeAddString(LBOOKS_THANK_YOU_LONG3100,		"Aber es ist definitiv auf meiner Liste", 1)

SafeAddString(LBOOKS_THANK_YOU3200,				"Zu viele Fundstellen", 1)
SafeAddString(LBOOKS_THANK_YOU_LONG3200,		"Bücherregal ist zu klein!", 1)

SafeAddString(LBOOKS_THANK_YOU3300,				"Nur ein paar mehr", 1)
SafeAddString(LBOOKS_THANK_YOU_LONG3300,		"Und du wirst etwas Grosses erreichen", 1)

SafeAddString(LBOOKS_THANK_YOU3400,				"Drei, Zwo, Eins ...", 1)
SafeAddString(LBOOKS_THANK_YOU_LONG3400,		"Der endgültige Countdown", 1)

SafeAddString(LBOOKS_THANK_YOU3478,				"Herzlichen Glückwunsch", 1)
SafeAddString(LBOOKS_THANK_YOU_LONG3478,		"Es gibt niemanden wie dich", 1)
...
SafeAddString(LBOOKS_RE_GOT_ALL_BOOKS				, "Du hast alle Ewige Erinnerung Bücher gesammelt. Herzlichen Glückwunsch!", 1)
SafeAddString(LBOOKS_RE_THREESHOLD_ERROR			, "Noch ein paar Ewige Erinnerung Bücher mehr, um diese dem Author zu melden..", 1)

SafeAddString(LBOOKS_REPORT_BOOK						, "Buch melden <<1>> ..", 1)
SafeAddString(LBOOKS_EIDETIC_REPORT					, "Vielen Dank dafür, dass Du eine Korrektur für LoreBooks meldest.\nWenn Du etwas beitragen möchtest aktivere das Teilen der Funde in den Einstellungen der Erweiterungen.\nWenn Du ein Pin korrigieren möchtest, bis Du hier genau richtig.\nBitte stell sicher, dass Du die neuste Version des Addons verwendest (Deine Version: <<1>>)\n\nMeine Meldung:", 1)

SafeAddString(LBOOKS_QUEST_PLACEHOLDER				, "Bitte gib den Questnamen ein", 1)
SafeAddString(LBOOKS_QUEST_LABEL						, "Questname:", 1)
...
SafeAddString(LBOOKS_RS_IN_DUNGEON					, "Buch in einem Verlies", 1)
SafeAddString(LBOOKS_RS_IN_DUNGEON_DESC			, "Dieses Buch ist in einem kleinen Verlies oder in einer Höhle ohne eigener Karte.", 1)

SafeAddString(LBOOKS_SEND_DATA						, "Korrektur senden", 1)

SafeAddString(LBOOKS_REPORT_THANK_YOU				, "Vielen Dank", 1)
SafeAddString(LBOOKS_REPORT_THANK_YOU_SEC			, "Deine Änderung wird geprüft und in der nächsten Version hinzugefügt.", 1)
