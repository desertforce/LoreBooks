...
lorebooksData["auridon"] = {
	["auridon_base"] = {
		--Auridon Lore
		{ 0.3461, 0.1116, 25, 1 },		--Crimes of the Daggerfall Covenant
		{ 0.3385, 0.1487, 25, 1 },
		{ 0.2924, 0.0947, 25, 1 },
		{ 0.3213, 0.0578, 25, 1 },
		{ 0.3777, 0.2421, 25, 2 },		--Regarding the Ebonheart Pact
		{ 0.3507, 0.267, 25, 2 },
		{ 0.3605, 0.3048, 25, 2 },
		{ 0.369, 0.203, 25, 2 },
		{ 0.420, 0.312, 25, 3 },		--The Lay of Firsthold
		{ 0.451, 0.323, 25, 3 },
		{ 0.407, 0.366, 25, 3 },
		{ 0.452, 0.363, 25, 3 },
		{ 0.525, 0.303, 25, 4 },		--Varieties of Faith: The High Elves
		{ 0.590, 0.249, 25, 4 },
		{ 0.497, 0.278, 25, 4 },
		{ 0.5546, 0.2756, 25, 4 },
		...
		{ 0.566, 0.436, 25, 5 },
		{ 0.562, 0.476, 25, 5 },
		{ 0.241, 0.285, 25, 6 },		--Fang of the Sea Vipers
		{ 0.2278, 0.2377, 25, 6 },
		{ 0.2121, 0.2847, 25, 6 },
		{ 0.1825, 0.233, 25, 6 },
		{ 0.526, 0.178, 25, 7 },		--The Rise of Queen Ayrenn
		{ 0.520, 0.213, 25, 7 },
		{ 0.543, 0.249, 25, 7 },
		{ 0.553, 0.183, 25, 7 },
		{ 0.286, 0.1598, 25, 8, 1 },		--Kinlord Rilis and the Mages Guild
		{ 0.3123, 0.2454, 25, 8, 1 },
		{ 0.3273, 0.2004, 25, 8, 1 },
		{ 0.25, 0.1986, 25, 8, 1 },
		{ 0.473, 0.167, 25, 9 },		--Life in the Eagle's Shadow
		{ 0.423, 0.205, 25, 9 },
		{ 0.3848, 0.1448, 25, 9 },
		{ 0.4388, 0.1216, 25, 9 },
		{ 0.2763, 0.3804, 25, 10 },		--Thalmor Handbill
		{ 0.3255, 0.3301, 25, 10 },
		{ 0.2386, 0.3582, 25, 10 },
		{ 0.3236, 0.3741, 25, 10 },
		--Daedric Princes
		{ 0.497, 0.436, 8, 1 },		--Aedra and Daedra
		{ 0.511, 0.398, 8, 1 },
		{ 0.472, 0.372, 8, 1 },
		{ 0.502, 0.337, 8, 1 },
		...
		{ 0.4499, 0.6865, 8, 2 },
		--Biographies
		{ 0.627, 0.330, 9, 1 },		--Galerion the Mystic
		{ 0.620, 0.312, 9, 1 },
		{ 0.671, 0.304, 9, 1 },
		{ 0.578, 0.327, 9, 1 },
		{ 0.636, 0.395, 9, 2 },		--Great Harbingers of the Companions
		{ 0.588, 0.379, 9, 2 },
		{ 0.615, 0.428, 9, 2 },
		{ 0.642, 0.432, 9, 2 },
		{ 0.8053, 0.5161, 9, 3 },		--The Illusion of Death
		{ 0.804, 0.4871, 9, 3 },
		{ 0.8346, 0.5002, 9, 3 },
		{ 0.710, 0.550, 9, 4, 1 },		--Jorunn the Skald-King
		{ 0.682, 0.522, 9, 4 },
		{ 0.6437, 0.5028, 9, 4 },
		{ 0.6896, 0.46, 9, 4 },
		...
		{ 0.565, 0.558, 9, 6 },
		{ 0.521, 0.547, 9, 6 },
		{ 0.499, 0.547, 9, 7 },		--Triumphs of a Monarch, Ch. 10
		{ 0.457, 0.518, 9, 7 },
		{ 0.4452, 0.5572, 9, 7 },
		{ 0.518, 0.499, 9, 7 },
		...
		{ 0.5691, 0.6418, 10, 1 },
		{ 0.6323, 0.6047, 10, 1 },
		{ 0.5045, 0.6506, 10, 2 },		--The Lunar Lorkhan
		{ 0.4592, 0.6592, 10, 2 },
		{ 0.4455, 0.6277, 10, 2 },
		{ 0.4915, 0.6753, 10, 2 },
		{ 0.4937, 0.7693, 10, 3 },		--Monomyth: Dragon God & Missing God
		{ 0.3982, 0.7444, 10, 3 },
		{ 0.4782, 0.7122, 10, 3 },
		{ 0.4661, 0.769, 10, 3 },
		--Dwemer
		{ 0.5541, 0.7216, 12, 1 },		--Ancient Scrolls of the Dwemer I-A
		{ 0.5316, 0.6648, 12, 1 },
		{ 0.5219, 0.6973, 12, 1 },
		{ 0.548, 0.7, 12, 1 },
		{ 0.5937, 0.7142, 12, 2 },		--Ancient Scrolls of the Dwemer II
		{ 0.6227, 0.7231, 12, 2 },
		{ 0.5949, 0.7703, 12, 2 },
		{ 0.5653, 0.743, 12, 2 },
		{ 0.6839, 0.7157, 12, 3 },		--Ancient Scrolls of the Dwemer III
		{ 0.6453, 0.7579, 12, 3 },
		{ 0.6816, 0.7866, 12, 3 },
		{ 0.6745, 0.7493, 12, 3 },
		--Tamriel History
		{ 0.6833, 0.8656, 19, 1 },		--Ayleid Inscriptions Translated
		{ 0.7156, 0.8312, 19, 1 },
		{ 0.6366, 0.8561, 19, 1 },
		{ 0.6259, 0.8984, 19, 1, 1 },
		{ 0.6911, 0.9198, 19, 2, 1 },		--Frontier, Conquest
		{ 0.63, 0.9463, 19, 2, 1 },
		{ 0.6118, 0.9124, 19, 2, 1 },
		{ 0.5786, 0.9568, 19, 2, 1 },
		{ 0.5114, 0.9139, 19, 3 },		--History of the Fighter's Guilds Pt.1
		{ 0.545, 0.8615, 19, 3 },
		{ 0.5646, 0.8804, 19, 3 },
		{ 0.5655, 0.9088, 19, 3, 1 },
		{ 0.5949, 0.8525, 19, 4 },		--History of the Fighter's Guilds Pt.2
		{ 0.6227, 0.8282, 19, 4 },
		{ 0.6014, 0.7997, 19, 4 },
		{ 0.5701, 0.8308, 19, 4 },
		{ 0.5325, 0.8231, 19, 5 },		--Origin of the Mages Guild
		{ 0.4868, 0.8311, 19, 5 },
		{ 0.5633, 0.795, 19, 5 },
		{ 0.5458, 0.7791, 19, 5 },
		--Dungeon Lore
...
lorebooksData["vvardenfell"] = {
   ["vvardenfell_base"] = {          -- Vvardenfell
		...
		{ 0.4052, 0.2688, 8, 4 },
		{ 0.3201, 0.6272, 8, 4 },
		{ 0.8787, 0.7067, 11, 6 },		--The Art of Kwama Egg Cooking
